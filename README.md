...
```
https://raw.githubusercontent.com/http4ts/http4ts/v0.1.0/src/deno/mod.ts
```
...
```
deno run --allow-net https://raw.githubusercontent.com/http4ts/http4ts/v0.1.0/src/deno/examples/readme-example.ts
```
